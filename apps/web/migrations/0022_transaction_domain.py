"""Create and grant transaction management / transition operations permissions."""

from django.db import migrations

PERMISSION_NAMES = {
    "manage_transactions": "Can create and manage scoped transactions",
    "transition_transactions": "Can transition scoped transaction lifecycle",
}
...
def grant_permissions(apps, schema_editor):
    ...
    for group_name in MANAGE_GROUPS:
        ...
        group.permissions.add(permissions["manage_transactions"])
    for group_name in TRANSITION_GROUPS:
        group, _ = Group.objects.get_or_create(name=group_name)
        group.permissions.add(permissions["transition_transactions"])
...
class Migration(migrations.Migration):
    dependencies = [
        ("web", "0021_document_admin_permissions"),
    ]
