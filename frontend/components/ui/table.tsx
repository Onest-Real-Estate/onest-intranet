...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "text-muted-foreground border-border/60 h-10 px-4 text-left align-middle text-xs font-semibold tracking-[0.06em] uppercase whitespace-nowrap",
        className,
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "border-border/50 px-4 py-2.5 align-middle whitespace-nowrap",
        className,
      )}
      {...props}
    />
