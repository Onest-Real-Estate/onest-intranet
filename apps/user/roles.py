...
_OPS_ALL = (
    ...
    "transactions.view_transaction_financials",
    "transactions.view_transaction_clients",
    "web.view_inventory",
    "web.view_reservations",
    "inventory.manage_inventory",
    "inventory.view_inventory_sensitive",
    "inventory.reserve_on_behalf",
    "inventory.approve_reservations",
    "inventory.override_reservations",
    "reservations.view_spaces",
    ...
    "web.view_compliance",
    "web.manage_policies",
    "web.approve_policies",
    "web.publish_policies",
