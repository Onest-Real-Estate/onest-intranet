...
export const HUB_NAV_REGISTRY: HubNavItem[] = [
  ...
  },
  {
    key: "office-info",
    label: "Office info",
    route: route("coming_soon", routes.coming_soon("office-info")),
    icon: Landmark,
    group: "my-office",
    order: 10,
    access: "authenticated",
    ...
    feature: "office-info",
    requiresOffice: true,
    activeMatch: active(routes.coming_soon("office-info")),
  },
  {
  ...
  {
    key: "admin-user-administration",
    label: "User administration",
    route: route("user_administration_index", routes.user_administration_index()),
    icon: IdCard,
    group: "administration",
    section: "admin-people",
    order: 15,
    access: "permission-protected",
    permissions: { all: ["user.view_user_administration"] },
    feature: "admin-user-administration",
    activeMatch: active(routes.user_administration_index()),
  },
  {
