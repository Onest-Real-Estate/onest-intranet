...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "stable_key",
                    models.SlugField(
                        help_text="Permanent identity used by audit records and integrations. Cannot be changed once the link exists.",
                        max_length=64,
                        unique=True,
                ...
                (
                    "destination_value",
                    models.CharField(
                        help_text="An https:// URL, or the key of an allowlisted internal destination.",
                        max_length=500,
                ...
                (
                    ...
                    models.CharField(
                        default="app-window",
                        help_text="Key of an approved mark shipped by the frontend.",
                        max_length=32,
                        verbose_name="icon",
                    ),
                ),
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0,
                        help_text="Lower sorts first. Positions may repeat; ties break by name so routine reordering never has to renumber the whole panel.",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("none", "No setup step"),
                            ("self_service", "Agent signs in directly"),
                            ("request_access", "Access must be requested"),
                            ("provisioned", "Provisioned during onboarding"),
                        ],
                        default="self_service",
                        max_length=32,
                        verbose_name="setup behaviour",
                    ),
                ),
                (
                    "company_wide",
                    models.BooleanField(
                        default=False,
                        help_text="Ignore office audience rows and show this to every office.",
                        verbose_name="visible company-wide",
                    ),
                ),
                (
                    "owner_scope",
                    models.CharField(
                        choices=[
                            ("company", "Company"),
                            ("scoped", "Office or region"),
                        ],
                        default="scoped",
                        max_length=16,
                        verbose_name="owner scope",
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "include_descendants",
                    models.BooleanField(
                        default=True, verbose_name="include descendants"
                    ),
                ),
                (
                    "link",
        ...
        migrations.AddIndex(
            model_name="quickaccesslink",
            index=models.Index(
                fields=["publish_start_at", "publish_end_at"], name="web_qal_window"
            ),
        ),
        migrations.AddIndex(
            model_name="quickaccesslink",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("publish_end_at__isnull", True),
                    ("publish_start_at__isnull", True),
                    ("publish_end_at__gt", models.F("publish_start_at")),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    models.Q(("owner_scope", "scoped"), _negated=True),
                    ("company_wide", False),
                    _connector="OR",
                ),
