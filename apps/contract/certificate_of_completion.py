...
def build_certificate_of_completion(*, facts: dict[str, Any]) -> bytes:
    ...
    ordered = [
        ...
        ("Party (agent)", facts.get("partyDisplayName")),
        ("Agent signer email", facts.get("signerEmail")),
        ("Agent signed at (UTC)", facts.get("signedAt")),
        ("Company signer email", facts.get("companySignerEmail")),
        ("Company signed at (UTC)", facts.get("companySignedAt")),
        ("Company signature id", facts.get("companySignaturePublicId")),
        ...
        ("Agent signature record id", facts.get("signaturePublicId")),
