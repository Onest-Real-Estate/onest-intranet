            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="user.useronboardingcase",
                        verbose_name="onboarding case",
                    ),
                ),
            ],
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("case", "tool"), name="user_onboard_tool_unique"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="A brief operational instruction; do not include sensitive data.",
                        max_length=200,
                        verbose_name="task",
                    ),
                ),
                ...
                (
                    "is_blocking",
                    models.BooleanField(
                        default=False, verbose_name="blocks activation"
                    ),
                ),
                (
                    "status",
