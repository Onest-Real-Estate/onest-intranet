...
import { BadgeCheck, CalendarClock, Megaphone, Pencil, Plus, Tag } from "lucide-react";
...
import {
  MarketingCreateFields,
  type MarketingDraftDefaults,
} from "@/components/marketing/MarketingCreateFields";
...
import type { MarketingAdministrationPageProps, MarketingAdminRow } from "@/types";
...
function audienceLabel(row: MarketingAdminRow): string {
...
function MarketingAdministrationPage() {
  const {
    assets,
    filterOptions,
    createOptions,
  ...
  return (
    <div className="grid gap-8">
      ...
      <PageHeader
        ...
        description="Draft, preview, schedule, and retire collateral your offices publish. Saving a draft never reaches anybody — publishing is a separate, deliberate step."
        actions={
      ...
      {capabilities.canAuthor ? (
        <CreateSheet
          ...
          action={routes.marketing_create()}
          csrfToken={csrfToken}
          formId="marketing-create-form"
        ...
        >
          <MarketingCreateFields
            ...
            assetTypes={createOptions.assetTypes}
      ...
      <SurfaceCard>
        ...
        <SurfaceCardContent className="grid gap-4">
          ...
          <DataTable
            frame="bleed"
            caption="Marketing assets you may manage"
            rows={assets.items}
            ...
            columns={[
              ...
              },
              {
                ...
                cell: (row) => (
                  <div className="flex flex-wrap items-center gap-1.5">
                    <Badge variant="outline">{row.assetType.label}</Badge>
                    {row.category ? (
              ...
              },
              {
                ...
                cell: (row) => (
                  <div className="flex items-center justify-end gap-2">
                    ...
                    >
                      <Link href={routes.marketing_edit(row.id)}>
...
export default function MarketingAdministration() {
  return (
    <PermissionRequired permission={MANAGE}>
      <MarketingAdministrationPage />
    </PermissionRequired>
  );
}

MarketingAdministration.layout = () =>
  [
    HubLayout,
    {
      context: {
