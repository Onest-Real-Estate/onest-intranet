"""Create and grant document publication and retirement permissions."""

from django.db import migrations

PERMISSION_NAMES = {
    "publish_documents": "Can publish, schedule, and supersede documents",
...
def grant_permissions(apps, schema_editor):
    ...
    for group_name in PUBLISH_GROUPS:
        ...
        group.permissions.add(permissions["publish_documents"])
    for group_name in RETIRE_GROUPS:
        group, _ = Group.objects.get_or_create(name=group_name)
        group.permissions.add(permissions["retire_documents"])
...
class Migration(migrations.Migration):
    dependencies = [
        ("web", "0020_compliance_policy_permissions"),
    ]
