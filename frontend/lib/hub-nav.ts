...
export const HUB_NAV_REGISTRY: HubNavItem[] = [
  ...
  {
    // One entry for Users, Roles & permissions, and New agents: they are tabs
    // of one page now. `admin_people` redirects to the first tab the reader
    // may open, so the entry shows for any of the three grants and never
    // lands on a 403. No feature flag — each tab is already live.
    key: "admin-people",
    label: "People",
    route: route("admin_people", routes.admin_people()),
    icon: Users,
    group: "administration",
    ...
    access: "permission-protected",
    permissions: {
      any: ["web.view_users", "web.assign_user_roles", "web.view_new_agents"],
    },
    activeMatch: {
      prefixes: [
        routes.admin_people(),
