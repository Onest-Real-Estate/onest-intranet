...
SENSITIVE_FIELD_PERMISSIONS: dict[str, str] = {
    ...
    "agent_split_percent": "contract.view_commission_terms",
    "office_split_percent": "contract.view_commission_terms",
    "mentor_percent": "contract.view_commission_terms",
    "referral_percent": "contract.view_commission_terms",
